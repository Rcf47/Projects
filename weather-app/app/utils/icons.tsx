import { CalendarDays, CloudDrizzle, CloudRain, CloudSun, Cloudy, Command, Droplets, Eye, Gauge, Github, Navigation, Search, Snowflake, SunDim, Sunset, Thermometer, ThermometerSun, UsersRound, Wind } from "lucide-react";
